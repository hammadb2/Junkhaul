...
abstract class Employee with _$Employee {
  const factory Employee({
    ...
    @JsonKey(name: 'pending_verification')
    @Default(false)
    ...
    @JsonKey(name: 'acknowledgments_done')
    @Default(false)
    bool acknowledgmentsDone,
...
abstract class OnboardingSummary with _$OnboardingSummary {
  ...
  factory OnboardingSummary.fromJson(Map<String, dynamic> json) =>
      _$OnboardingSummaryFromJson(json);
}
...
abstract class LoginResponse with _$LoginResponse {
  const factory LoginResponse({required Employee employee}) = _LoginResponse;
