...
class _AcknowledgmentsStepState extends State<AcknowledgmentsStep> {
  ...
  static const _policies = [
    ...
    {
      'label': 'Vehicle use policy',
      'url': 'https://www.junkhaul.ca/vehicle-use-policy',
    },
    {
      'label': 'Code of conduct',
      'url': 'https://www.junkhaul.ca/code-of-conduct',
    },
    {
      'label': 'Uniform policy',
      'url': 'https://www.junkhaul.ca/uniform-policy',
    },
  ];
      ...
      children: [
        Expanded(
          child: ListView(
            ...
            children: [
              ...
              const Text(
                'Four short policies. Give them a read.',
              ...
              CheckboxListTile(
                ...
                title: const Text(
                  "I've read and agree to all four policies above.",
                  style: TextStyle(
                    fontSize: 13,
        ...
        Padding(
          ...
          child: JhPrimaryButton(
            label: 'Continue',
            onPressed: _agree ? widget.onNext : null,
          ),
        ),
      ],
    );
