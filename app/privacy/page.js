  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <h2 className="text-xl font-bold text-[#1a3a5c] mt-10 mb-4 pb-2 border-b border-gray-200">1. Who We Are</h2>
        ...
        <h2 className="text-xl font-bold text-[#1a3a5c] mt-10 mb-4 pb-2 border-b border-gray-200">2. What Information We Collect</h2>
        <h3 className="text-lg font-semibold text-[#1a3a5c] mt-6 mb-2">2.1 When you request a quote or book a job</h3>
        ...
        <h3 className="text-lg font-semibold text-[#1a3a5c] mt-6 mb-2">2.2 When you call, text, or interact with us by phone</h3>
        ...
        <h3 className="text-lg font-semibold text-[#1a3a5c] mt-6 mb-2">2.3 After a job is completed</h3>
        ...
        <h3 className="text-lg font-semibold text-[#1a3a5c] mt-6 mb-2">2.4 Website and app usage</h3>
        ...
        <h2 className="text-xl font-bold text-[#1a3a5c] mt-10 mb-4 pb-2 border-b border-gray-200">3. Why We Collect It</h2>
        ...
        <h2 className="text-xl font-bold text-[#1a3a5c] mt-10 mb-4 pb-2 border-b border-gray-200">4. Consent</h2>
        ...
        <h2 className="text-xl font-bold text-[#1a3a5c] mt-10 mb-4 pb-2 border-b border-gray-200">5. Who We Share Information With</h2>
        ...
        <h2 className="text-xl font-bold text-[#1a3a5c] mt-10 mb-4 pb-2 border-b border-gray-200">6. How Long We Keep Information</h2>
        ...
        <h2 className="text-xl font-bold text-[#1a3a5c] mt-10 mb-4 pb-2 border-b border-gray-200">7. How We Protect Your Information</h2>
        ...
        <h2 className="text-xl font-bold text-[#1a3a5c] mt-10 mb-4 pb-2 border-b border-gray-200">9. Cookies &amp; Online Advertising</h2>
        ...
        <h2 className="text-xl font-bold text-[#1a3a5c] mt-10 mb-4 pb-2 border-b border-gray-200">11. Contact Us</h2>
