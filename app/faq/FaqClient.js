  ...
  return (
    <main className="min-h-dvh flex flex-col px-6 py-6 max-w-md mx-auto">
      ...
      <Section title="💰 Extra fees">
        <ul className="space-y-1.5 text-sm text-gray-700">
          <li>Refrigerators / freezers / AC / water coolers: <b>+$40</b> per appliance (Freon removal)</li>
      ...
      <Section title="📅 When do we run?">
        <p className="text-sm text-gray-700">
          Pickups are <b>Sundays only</b>. Same-day pickup is available when slots are open. Slots: 7:30 AM, 9:00 AM, 11:00 AM, 1:00 PM.
        </p>
      </Section>
      ...
      <p className="text-center text-sm text-gray-500 mt-6 mb-4">
        Questions?{' '}
        <a href="tel:+15873250751" className="text-orange-500 font-semibold underline">
          Call or text (587) 325-0751
        </a>{' '}
        any time.
      </p>
    </main>
