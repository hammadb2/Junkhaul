  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Crew Privacy Policy</h1>
        ...
        <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">1. Purpose &amp; How This Differs From Our Customer Privacy Policy</h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">2. Who This Applies To</h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">3. Information We Collect During Onboarding</h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">4. Information Collected While You&#39;re Working With Us</h2>
        <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-2">4.1 Location tracking</h3>
        ...
        <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-2">4.2 Job, schedule, and performance records</h3>
        ...
        <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-2">4.3 Calls and the crew Dispatch line</h3>
        ...
        <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-2">4.4 Payroll and tax records</h3>
        ...
        <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-2">4.5 Photos taken as part of the job</h3>
        ...
        <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">5. Why We Collect and Use This Information</h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">6. Who Has Access</h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">7. How Long We Keep It</h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">9. Keeping Your Information Secure</h2>
