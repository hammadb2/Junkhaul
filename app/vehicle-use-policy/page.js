  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Vehicle Use Policy</h1>
        ...
        <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">2. Who Can Drive a Company Vehicle</h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">3. Before You Drive: Pre Trip Inspection</h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">4. End of Day Truck Check</h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">5. Distracted Driving &amp; Phone Use</h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">6. Safe Operation on Job Sites</h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">7. Fuel, Mileage &amp; Wear</h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">8. Personal Use</h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">9. GPS &amp; Location Tracking</h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">10. If You&#39;re Involved in an Accident</h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">11. Truck Wrap &amp; Vehicle Appearance</h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">12. Breakdown Mid Route</h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4 pb-2 border-b border-gray-200">13. Consequences of Policy Violations</h2>
