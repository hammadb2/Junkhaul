...
async function computeCostSnapshot({ quoteInput, client = supabaseAdmin }) {
  ...
  const booking = {
    ...
    // Real AI-estimated weight (when available) drives truck selection —
    // see selectTruckFromProfiles in lib/costConfig.js — instead of the
    // load_size tier's rough representative figure.
