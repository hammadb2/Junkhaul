...
// migration).
// ------------------------------------------------------------
function scoreDonationCenterCandidate(center, { categories, pickup, resaleFriendly }) {
  const breakdown = {};
...
function scoreStorageCandidate(facility, { pickup }) {
  const breakdown = {};
...
function scoreLandfillCandidate(landfill, { pickup }) {
