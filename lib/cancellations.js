...
export const cancelBooking = async (booking_id, reason, cancelled_by) => {
  ...
  const customerMessage = policy.deposit_refunded
    ...
    : `Hi ${booking.name}, your booking ${booking.booking_ref} is cancelled. Since it's within 24 hours of your pickup time, the $50 deposit is non-refundable per our policy.\n\nWant to rebook? Head to junkhaul.ca or call us.`;
